...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background: linear-gradient(135deg, #5a2d9e, #d500a7, #00bcd4);
            background-size: 400% 400%;
            color: white;
            scroll-behavior: smooth;
            animation: gradientAnimation 10s infinite;
            transition: background-color 0.3s ease, color 0.3s ease;
            cursor: url('images/cursor-cat.png'), auto;
        }
        ...
        header {
            ...
            border-bottom: 5px solid #f5a7b9;
        ...
        header nav a {
            ...
            border-radius: 30px; /* More rounded links */
